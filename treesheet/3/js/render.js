...
let dataRows = [
  { type: 'GenericNode',
    height: 21,
    /*id consists of two integers, first one is clientId (it is provided by server) second one is id generated by client*/
    /*        clientId is maintained by server based on clientIdentificationToken (some token generated by every client to uniquely identify it)
                        that clientIdentificationToken should be generated based on some client data + UUID */
    id: [23, 34], pId: null,
    data: {
